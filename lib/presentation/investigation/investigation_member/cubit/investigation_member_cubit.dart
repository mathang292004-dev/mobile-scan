...
/// State for Investigation Member Dashboard
class InvestigationMemberState extends Equatable {
  const InvestigationMemberState({
    this.data,
  ...
  factory InvestigationMemberState.initial() =>
      const InvestigationMemberState(
        processState: ProcessState.none,
        selectedMetricIndex: 0,
      );

  InvestigationMemberState copyWith({
    ...
    return InvestigationMemberState(
      data: data ?? this.data,
...
/// Cubit for managing Investigation Member Dashboard state — UI only with dummy data
class InvestigationMemberCubit extends Cubit<InvestigationMemberState> {
  InvestigationMemberCubit() : super(InvestigationMemberState.initial());
  ...
  void clearCache() {
    emit(InvestigationMemberState.initial());
  }

  /// Load dummy dashboard data
  /// Metrics: 0=Total Tasks, 1=In Progress, 2=Completed
