...
/// Widget for displaying a list of users with add/remove functionality.
/// Used in role selection dialogs.
class RoleUserListWidget extends StatefulWidget {
  ...
  @override
  State<RoleUserListWidget> createState() => RoleUserListWidgetState();
}

class RoleUserListWidgetState extends State<RoleUserListWidget> {
  ...
  void addAllSelectedUsers() {
    try {
      ...
      if (widget.roleId != null && widget.roleId!.isNotEmpty) {
        cubit.commitAllSessionSelections();
      } else {
        for (final userData in cubit.state.sessionSelectedUsers.values) {
          widget.onUserAdded?.call(userData);
        }
        cubit.clearSessionSelections();
      }
    } catch (e) {
      debugPrint('Error adding selected users: $e');
    }
  }
  ...
  static RoleUserListWidgetState? of(BuildContext context) {
    return context.findAncestorStateOfType<RoleUserListWidgetState>();
  }
      ...
      builder: (context, roleState) {
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            final bool isConfirming = roleState.confirmSelectionIndexes
                .contains(index);
            ...
            final bool isNowSelected = roleState.sessionSelectedUsers
                .containsKey(userId);

            return isAlreadySelected && !isNowSelected
                ? SizedBox.shrink()
                : Padding(
                        ...
                        children: [
                          ...
                          if (widget.showAddIcon)
                            AnimatedSwitcher(
                              ...
                              child: isNowSelected
                                  ? Row(
                                      key: ValueKey('session_selected_$userId'),
                                      children: [
                                        Container(
                                          width: 37,
                                          height: 35,
                                        ...
                                        Container(
                                          ...
                                          child: IconButton(
                                            ...
                                            onPressed: () {
                                              ...
                                              cubit.removeFromSessionSelection(
                                                userId,
                                              );
                                            },
                                          ),
                                      ...
                                      children: [
                                          ...
                                          child: IconButton(
                                            ...
                                            onPressed: () {
                                              ...
                                              if (userId.isNotEmpty) {
                                                cubit.addToSessionSelection(
                                                  userId,
                                                  emp,
                                                );
                                                cubit
                                                    .removeConfirmSelectionIndex(
                                                      index,
                                                    );
                                              } else {
                                                cubit
                                        ...
                                        IconButton(
                                          ...
                                          onPressed: () {
                                            final cubit = context
                                                .read<RoleDetailsCubit>();
                                            cubit.removeConfirmSelectionIndex(
                                              index,
                                            );
                                          },
                                        ),
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  shape: BoxShape.circle,
                                  color: ColorHelper.recycleBin.withValues(
                                    alpha: 0.1,
                                  ),
                                ),
                                child: Center(
